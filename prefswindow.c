	...
	result = MUI_NewObject(MUIC_Group,
		...
		MUIA_Group_Child, MUI_NewObject(MUIC_Group,
			...
			MUIA_Group_Child, MUI_NewObject(MUIC_Group,
				...
				MUIA_Group_Child, MUI_NewObject(MUIC_Image,
					MUIA_Unicode, TRUE,
					MUIA_ObjectID, USD_PREFS_LOGS_UNICODE_ONOFF_CHECK,
					MUIA_UserData, USD_PREFS_LOGS_UNICODE_ONOFF_CHECK,
					MUIA_Image_Spec, "6:15",
					MUIA_ShowSelState, FALSE,
					MUIA_Selected, FALSE,
					MUIA_InputMode, MUIV_InputMode_Toggle,
					MUIA_CycleChain, TRUE,
					MUIA_ShortHelp, GetString(MSG_PREFS_LOGS_UNICODE_ONOFF_HELP),
				TAG_END),
