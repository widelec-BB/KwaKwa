...
static inline Object *CreateProgramPrefs(CONST_STRPTR statuses[6], CONST_STRPTR input_gadget_options[3])
{
	...
	result = MUI_NewObject(MUIC_Group,
		...
		MUIA_Group_Child, MUI_NewObject(MUIC_Group,
			...
			MUIA_Group_Child, MUI_NewObject(MUIC_Group,
				MUIA_Group_Horiz, TRUE,
				MUIA_Group_Child, (IPTR)CheckBox(USD_PREFS_PROGRAM_MAIN_WINDOW_SHOW_START, TRUE, GetString(MSG_PREFS_PROGRAM_MAIN_WINDOW_SHOW_HELP)),
			...
			MUIA_Group_Child, (show_hide_but_check = MUI_NewObject(MUIC_Group,
				MUIA_Group_Horiz, TRUE,
				MUIA_Group_Child, (IPTR)CheckBox(USD_PREFS_PROGRAM_MAIN_WINDOW_SHOW_HIDE_BUTTON, TRUE, GetString(MSG_PREFS_PROGRAM_MAIN_WINDOW_SHOW_HIDE_BUTTON_HELP)),
		...
		MUIA_Group_Child, MUI_NewObject(MUIC_Group,
			...
			MUIA_Group_Child, MUI_NewObject(MUIC_Group,
				MUIA_Group_Horiz, TRUE,
				MUIA_Group_Child, (IPTR)(auto_check = CheckBox(USD_PREFS_PROGRAM_CONNECT_AUTO_CHECK, FALSE, GetString(MSG_PREFS_PROGRAM_CONNECT_AUTO_HELP))),
		...
		MUIA_Group_Child, MUI_NewObject(MUIC_Group,
			...
			MUIA_Group_Child, MUI_NewObject(MUIC_Group,
				...
				MUIA_Group_Child, MUI_NewObject(MUIC_Group,
					...
					MUIA_Group_Child, (IPTR)CheckBox(USD_PREFS_TW_HEADLINE_BOLD, TRUE, GetString(MSG_PREFS_TALKWINDOW_HEADLINE_BOLD_HELP)),
					MUIA_Group_Child, StringLabel(GetString(MSG_PREFS_TALKWINDOW_HEADLINE_BOLD), "\33l"),

					MUIA_Group_Child, (IPTR)CheckBox(USD_PREFS_TW_HEADLINE_ITALIC, FALSE, GetString(MSG_PREFS_TALKWINDOW_HEADLINE_ITALICS_HELP)),
					MUIA_Group_Child, StringLabel(GetString(MSG_PREFS_TALKWINDOW_HEADLINE_ITALICS), "\33l"),

					MUIA_Group_Child, (IPTR)CheckBox(USD_PREFS_TW_HEADLINE_BACKGROUND, FALSE, GetString(MSG_PREFS_TALKWINDOW_HEADLINE_BACKGROUND_HELP)),
					MUIA_Group_Child, StringLabel(GetString(MSG_PREFS_TALKWINDOW_HEADLINE_BACKGROUND), "\33l"),

					MUIA_Group_Child, (IPTR)CheckBox(USD_PREFS_TW_HEADLINE_MAXWIDTH, FALSE, GetString(MSG_PREFS_TALKWINDOW_HEADLINE_MAXWIDTH_HELP)),
					MUIA_Group_Child, StringLabel(GetString(MSG_PREFS_TALKWINDOW_HEADLINE_MAXWIDTH), "\33l"),

					MUIA_Group_Child, (IPTR)CheckBox(USD_PREFS_TW_HEADLINE_REVERSE, FALSE, GetString(MSG_PREFS_TALKWINDOW_HEADLINE_REVERSE_HELP)),
					MUIA_Group_Child, StringLabel(GetString(MSG_PREFS_TALKWINDOW_HEADLINE_REVERSE), "\33l"),

					MUIA_Group_Child, (IPTR)CheckBox(USD_PREFS_TW_HEADLINE_INSERT_NEWLINE, TRUE, GetString(MSG_PREFS_TALKWINDOW_HEADLINE_ADD_NEWLINE_HELP)),
				...
				MUIA_Group_Child, MUI_NewObject(MUIC_Group,
					...
					MUIA_Group_Child, (IPTR)CheckBox(USD_PREFS_TW_SYSTEMMSG_BOLD, FALSE, GetString(MSG_PREFS_TALKWINDOW_SYSTEMMSG_BOLD_HELP)),
					MUIA_Group_Child, StringLabel(GetString(MSG_PREFS_TALKWINDOW_SYSTEMMSG_BOLD), "\33l"),

					MUIA_Group_Child, (IPTR)CheckBox(USD_PREFS_TW_SYSTEMMSG_ITALIC, TRUE, GetString(MSG_PREFS_TALKWINDOW_SYSTEMMSG_ITALICS_HELP)),
					MUIA_Group_Child, StringLabel(GetString(MSG_PREFS_TALKWINDOW_SYSTEMMSG_ITALICS), "\33l"),

					MUIA_Group_Child, (IPTR)(systemmsg_title = CheckBox(USD_PREFS_TW_SYSTEMMSG_HEADLINE, TRUE, GetString(MSG_PREFS_TALKWINDOW_SYSTEMMSG_ADD_HEADLINE_HELP))),
					MUIA_Group_Child, StringLabel(GetString(MSG_PREFS_TALKWINDOW_SYSTEMMSG_ADD_HEADLINE), "\33l"),

					MUIA_Group_Child, (IPTR)(systemmsg_title_bg = CheckBox(USD_PREFS_TW_SYSTEMMSG_BACKGROUND, FALSE, GetString(MSG_PREFS_TALKWINDOW_SYSTEMMSG_BACKGROUND_HELP))),
					MUIA_Group_Child, (systemmsg_title_bg_label = StringLabel(GetString(MSG_PREFS_TALKWINDOW_SYSTEMMSG_BACKGROUND), "\33l")),

					MUIA_Group_Child, (IPTR)(systemmsg_title_width = CheckBox(USD_PREFS_TW_SYSTEMMSG_MAXWIDTH, FALSE, GetString(MSG_PREFS_TALKWINDOW_SYSTEMMSG_MAXWIDTH_HELP))),
					MUIA_Group_Child, (systemmsg_title_width_label = StringLabel(GetString(MSG_PREFS_TALKWINDOW_SYSTEMMSG_MAXWIDTH), "\33l")),

					MUIA_Group_Child, (IPTR)(systemmsg_title_reverse = CheckBox(USD_PREFS_TW_SYSTEMMSG_HEADLINE_REVERSE, FALSE, GetString(MSG_PREFS_TALKWINDOW_SYSTEMMSG_HEADLINE_REVERSE_HELP))),
			...
			MUIA_Group_Child, MUI_NewObject(MUIC_Group,
				...
				MUIA_Group_Child, MUI_NewObject(MUIC_Group,
					MUIA_Group_Horiz, TRUE,
					MUIA_Group_Child, (IPTR)CheckBox(USD_PREFS_TW_TABTITLE_IMAGE_ONOFF, FALSE, GetString(MSG_PREFS_TALKWINDOW_TABTITLE_IMAGE_ONOFF_HELP)),
					MUIA_Group_Child, StringLabel(GetString(MSG_PREFS_TALKWINDOW_TABTITLE_IMAGE_ONOFF), "\33l"),
					MUIA_Group_Child, EmptyRectangle(100),
				TAG_END),
				MUIA_Group_Child, MUI_NewObject(MUIC_Group,
					MUIA_Group_Horiz, TRUE,
					MUIA_Group_Child, (IPTR)CheckBox(USD_PREFS_TW_CONTACTINFOBLOCK_ONOFF, TRUE, GetString(MSG_PREFS_TALKWINDOW_CONTACTINFOBLOCK_ON_OFF_HELP)),
					MUIA_Group_Child, StringLabel(GetString(MSG_PREFS_TALKWINDOW_CONTACTINFOBLOCK_ON_OFF), "\33l"),
					MUIA_Group_Child, EmptyRectangle(100),
				TAG_END),
				MUIA_Group_Child, MUI_NewObject(MUIC_Group,
					MUIA_Group_Horiz, TRUE,
					MUIA_Group_Child, (IPTR)(toolbar_onoff = CheckBox(USD_PREFS_TW_TOOLBAR_ONOFF, TRUE, GetString(MSG_PREFS_TALKWINDOW_TOOLBAR_ON_OFF_HELP))),
				...
				MUIA_Group_Child, MUI_NewObject(MUIC_Group,
					MUIA_Group_Horiz, TRUE,
					MUIA_Group_Child, (IPTR)(pic_width_onoff = CheckBox(USD_PREFS_TW_PICTURES_ONOFF, TRUE, GetString(MSG_PREFS_TALKWINDOW_PICTURES_ON_OFF_HELP))),
...
static inline Object *CreateLogsPrefs(VOID)
{
	...
	result = MUI_NewObject(MUIC_Group,
		...
		MUIA_Group_Child, MUI_NewObject(MUIC_Group,
			...
			MUIA_Group_Child, MUI_NewObject(MUIC_Group,
				MUIA_Group_Horiz, TRUE,
				MUIA_Group_Child, (IPTR)CheckBox(USD_PREFS_LOGS_ONOFF_CHECK, TRUE, GetString(MSG_PREFS_LOGS_ONOFF_HELP)),
			...
			MUIA_Group_Child, MUI_NewObject(MUIC_Group,
				MUIA_Group_Horiz, TRUE,
				MUIA_Group_Child, (IPTR)CheckBox(USD_PREFS_LOGS_UNICODE_ONOFF_CHECK, FALSE, GetString(MSG_PREFS_LOGS_UNICODE_ONOFF_HELP)),
				MUIA_Group_Child, StringLabel(GetString(MSG_PREFS_LOGS_UNICODE_ONOFF), "\33l"),
				MUIA_Group_Child, EmptyRectangle(100),
			TAG_END),

			MUIA_Group_Child, MUI_NewObject(MUIC_Group,
				MUIA_Group_Horiz, TRUE,
				MUIA_Group_Child, (IPTR)(history_on = CheckBox(USD_PREFS_HISTORY_ONOFF_CHECK, FALSE, GetString(MSG_PREFS_LOGS_HISTORY_ONOFF_HELP))),
		...
		MUIA_Group_Child, (history_group = MUI_NewObject(MUIC_Group,
			...
			MUIA_Group_Child, MUI_NewObject(MUIC_Group,
				MUIA_Group_Horiz, TRUE,
				MUIA_Group_Child, (IPTR)CheckBox(USD_PREFS_HISTORY_SAVE_SYSTEMMSGS, TRUE, GetString(MSG_PREFS_LOGS_HISTORY_SAVE_SYSTEMMSGS_HELP)),
		...
		MUIA_Group_Child, MUI_NewObject(MUIC_Group,
			...
			MUIA_Group_Child, MUI_NewObject(MUIC_Group,
				MUIA_Group_Child, MUI_NewObject(MUIC_Group, /* descs on/off */
					MUIA_Group_Horiz, TRUE,
					MUIA_Group_Child, (IPTR)(show_descs = CheckBox(USD_PREFS_CONTACTSLIST_SHOWDESC_CHECK, TRUE, GetString(MSG_PREFS_CONTACTSLIST_DESC_ONOFF_HELP))),
				...
				MUIA_Group_Child, MUI_NewObject(MUIC_Group, /* avatars on/off */
					MUIA_Group_Horiz, TRUE,
					MUIA_Group_Child, (IPTR)(show_avatars = CheckBox(USD_PREFS_CONTACTSLIST_SHOWAVATARS_CHECK, TRUE, GetString(MSG_PREFS_CONTACTSLIST_AVATARS_ONOFF_HELP))),
...
static inline Object *CreateEmoticonsPrefs(VOID)
{
	...
	result = MUI_NewObject(MUIC_Group,
		...
		MUIA_Group_Child, MUI_NewObject(MUIC_Group,
			...
			MUIA_Group_Columns, 2,
			MUIA_Group_Child, (IPTR)(onoff = CheckBox(USD_PREFS_EMOTICONS_ONOFF, TRUE, GetString(MSG_PREFS_EMOTICONS_ON_OFF_HELP))),
			MUIA_Group_Child, MUI_NewObject(MUIC_Group,
				MUIA_Group_Horiz, TRUE,
				MUIA_Group_Child, StringLabel(GetString(MSG_PREFS_EMOTICONS_ON_OFF), "\33l"),
				MUIA_Group_Child, EmptyRectangle(100),
			TAG_END),
			MUIA_Group_Child, (IPTR)CheckBox(USD_PREFS_EMOTICONS_LONG_ONOFF, TRUE, GetString(MSG_PREFS_EMOTICONS_LONG_ON_OFF_HELP)),
			MUIA_Group_Child, MUI_NewObject(MUIC_Group,
				MUIA_Group_Horiz, TRUE,
