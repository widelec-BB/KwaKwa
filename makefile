...
$(OBJDIR)application.c.o: application.c globaldefines.h application.h mainwindow.h prefswindow.h contactslist.h support.h talkwindow.h \
 ...
 kwakwa_api/protocol.h kwakwa_api/defs.h moduleslogwindow.h slaveprocess.h historysql.h historywindow.h brokerhook.h
	@$(COMPILE_FILE)
...
$(OBJDIR)brokerhook.c.o: brokerhook.c brokerhook.h support.h mainwindow.h
	@$(COMPILE_FILE)
	@$(COMPILE) -c -o $(OBJDIR)brokerhook.c.o brokerhook.c
...
OBJS = $(OBJDIR)application.c.o $(OBJDIR)contactslist.c.o $(OBJDIR)locale.c.o $(OBJDIR)main.c.o $(OBJDIR)mainwindow.c.o $(OBJDIR)descwindow.c.o \
 ...
 $(OBJDIR)historyconversationslist.c.o $(OBJDIR)brokerhook.c.o
