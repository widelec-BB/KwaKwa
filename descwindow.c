...
static inline Object *StatusButton(CONST_STRPTR label, CONST_STRPTR help)
{
	...
	obj = (Object*)DoSuperNew(cl, obj,
		...
		MUIA_Window_RootObject, (ULONG)MUI_NewObject(MUIC_Group,
			...
			MUIA_Group_Child, (ULONG)MUI_NewObject(MUIC_Group,
				...
				MUIA_Group_Child, (IPTR)EmptyRectangle(40),
				MUIA_Group_Child, (IPTR)(buttons[0] = StatusButton(STATUS_IMAGE_AVAILABLE_MUI_STR, GetString(MSG_GG_STATUS_AVAIL))),
				MUIA_Group_Child, (IPTR)(buttons[1] = StatusButton(STATUS_IMAGE_AWAY_MUI_STR, GetString(MSG_GG_STATUS_AWAY))),
				MUIA_Group_Child, (IPTR)(buttons[2] = StatusButton(STATUS_IMAGE_INVISIBLE_MUI_STR, GetString(MSG_GG_STATUS_INVISIBLE))),
				MUIA_Group_Child, (IPTR)(buttons[3] = StatusButton(STATUS_IMAGE_UNAVAILABLE_MUI_STR, GetString(MSG_GG_STATUS_UNAVAIL))),
				MUIA_Group_Child, (IPTR)EmptyRectangle(5),
				MUIA_Group_Child, (IPTR)(buttons[4] = StatusButton(STATUS_IMAGE_FFC_MUI_STR, GetString(MSG_GG_STATUS_FFC))),
				MUIA_Group_Child, (IPTR)(buttons[5] = StatusButton(STATUS_IMAGE_DND_MUI_STR, GetString(MSG_GG_STATUS_DND))),
